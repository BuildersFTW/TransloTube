...
def _getVoiceOver(videoID, translatedTranscript, originalLang, targetLanguage, voiceID=1):
    ...
    for segment in translatedTranscript:
        ...
        temp_audio_path = os.path.join("home", "rudra", "translotube", "TransloTube-falcon", "src", "staticfiles", "audio", f"{videoID}_temp_audio.mp3")
        try:
            print("GetVoiceover")
    ...
    voiceover_dir = os.path.join("home", "rudra", "translotube", "TransloTube-falcon", "src", "staticfiles", "audio", f"{videoID}_final_audio.mp3")
